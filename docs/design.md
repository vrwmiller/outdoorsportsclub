...
| 19 | **Surface UI/UX design** | Tracked as Issue #84. Wireframes and component library selection are required for all four surfaces (Club Website, Member Portal, Admin Portal, Kiosk View) before `src/` implementation begins. |
