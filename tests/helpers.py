...
def full_member_profile_row(
    ...
    return [
        ...
        {"stringValue": first_name} if first_name else {"isNull": True},
        {"stringValue": last_name} if last_name else {"isNull": True},
        {"stringValue": date_of_birth} if date_of_birth else {"isNull": True},
        {"stringValue": street_address} if street_address else {"isNull": True},
        {"stringValue": city} if city else {"isNull": True},
        {"stringValue": state} if state else {"isNull": True},
        {"stringValue": zip} if zip else {"isNull": True},
        {"stringValue": notification_email} if notification_email else {"isNull": True},
